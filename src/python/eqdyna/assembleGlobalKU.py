...
def calcHourglassResist(xp, inv, dispArr, velArr, force, rdampk, scratch=None):
    ...
    then a sign-bit flip), just not reallocated. See NOTES_numpy_wedge_perf.md
    for the measured before/after ms/step on test.tpv36 and the sha256
    parity check this was gated on."""
