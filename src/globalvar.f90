...
MODULE globalvar
    ...
    real (kind = dp),   allocatable, dimension(:)     :: brhs, alhs, v1,   d1,   s1,   miuonf,  &
                                                         vponf,      eleporep,   pstrain,       & 
                                                         eledet,     fnms 
    real (kind = dp),   allocatable, dimension(:,:)   :: x,    d,    v,    mat,  shl,  fnft,    &
                                                         arn,  r4nuc,      arn4m,      slp4fri, &
                                                         state,      elemass,    ss,   plane1,  &
                                                         plane2
    ...
    real(kind = dp)     :: rhow=1000.d0, b11=0.926793, b33=1.073206, b13=-0.169029, &
        critt0=0.2d0, srcrad0=2500.d0, vrupt0=1500.d0, critd0, cohes, brangle, &
