...
* 20260923 v5.16.1 release notes
  ...
  * Note - patch release: no solver source, no reference, no bound and no rule text changed. Gated on unit + regression (exit 0) in an isolated worktree; the e2e sweep was NOT re-run for it and nothing here claims one.
